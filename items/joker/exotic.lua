SMODS.Joker{
    ...
    loc_txt = {
        ...
        text = {
            'Gains {X:dark_edition,C:white}^^#2# {} Score',
			' when {X:attention,C:white} ANYTHING {} happens',
	...
	calculate = function(self, card, context)
		-- i cannot fucking salvage this
		-- im just gonna make its scaling happen every time silently
